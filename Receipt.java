...
import possystem.EmptyListException;
import possystem.InsufficientQuantityException;
import possystem.ItemNotFoundException;
...
public class Receipt {
	...
	Receipt(boolean sale) {
		...
		if (sale)
			...
			isSale = false;
                ...
                //everytime the constructor is called you add to the salesReport.
                salesReport.add(this);
	...
	public Item removeItem (Item toRemove, int quantity) throws EmptyListException, ItemNotFoundException, InsufficientQuantityException {
		if (isEmpty()) 
	...
	public void printReceipt(Date date, String cashierID, double totalAmt) {
		...
		System.out.println("Thanks for shopping!!!!");
			...
			System.out.println(date);
			System.out.println("Cashier ID: " + cashierID);
			System.out.println("Return #:" + receiptNum);
